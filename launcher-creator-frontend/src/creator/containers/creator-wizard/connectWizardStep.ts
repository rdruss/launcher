...
import { getThisStepStateContext, isThisCurrentStep, isThisStepLocked, isThisStepValid } from '../../reducers/wizardReducer';
...
const mapDispatchToProps = (dispatch, props: StepProps<object>) => ({
  ...
  goToStep: (step = props.stepId) => dispatch(wizardAction.goToStep(step)),
});
